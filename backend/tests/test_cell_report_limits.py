...
from app.routers.cell_meetings import _OBSERVACOES_MAX, _OFERTA_MAX
...
def test_human_and_agent_report_limits_share_one_domain_boundary() -> None:
    ...
    assert MAX_CELL_REPORT_OBSERVATIONS_LENGTH == 2_000
    assert MAX_CELL_REPORT_OBSERVATIONS_BYTES == 8_000
    assert _OBSERVACOES_MAX == MAX_CELL_REPORT_OBSERVATIONS_LENGTH
    assert MAX_REPORT_OBSERVATIONS_LENGTH == (
        MAX_CELL_REPORT_OBSERVATIONS_LENGTH
    )
    assert MAX_REPORT_OBSERVATIONS_BYTES == MAX_CELL_REPORT_OBSERVATIONS_BYTES
    assert MAX_CELL_REPORT_OBSERVACOES_LENGTH == (
        MAX_CELL_REPORT_OBSERVATIONS_LENGTH
    )
    assert MAX_CELL_REPORT_OBSERVACOES_BYTES == (
        MAX_CELL_REPORT_OBSERVATIONS_BYTES
    )
