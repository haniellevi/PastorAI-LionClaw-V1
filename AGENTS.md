...
3. **Dividir por tamanho.** Pequeno/médio (CRUD, ajuste, correção) → **Codex direto** (nesta pasta). Módulo **grande/novo** → **pipeline** do LionClaw (ou Codex com um plano antes).
...
## Onde trabalhar
Mudanças no PastorAI são feitas **nesta pasta** (esta conversa do Codex). O LionClaw é outra ferramenta (o app que gera/orquestra pipelines) — não editar o PastorAI de lá.
