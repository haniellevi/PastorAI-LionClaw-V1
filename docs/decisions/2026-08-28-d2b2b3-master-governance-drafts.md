...
Revisao offline independente, por seguranca e arquitetura de banco, da proposta
e do manifesto. O gate pode aprovar somente o desenho de uma missao posterior e
separada para derivar o schema canonico em PostgreSQL 17 descartavel. A
atestacao read-only de DEV e PROD permanece posterior e independente; nada aqui
