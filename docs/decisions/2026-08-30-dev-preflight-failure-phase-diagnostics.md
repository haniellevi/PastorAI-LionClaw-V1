...
probe vivo, nova execução, retry, senha, autenticação, acesso a DEV ou PROD,
banco, logs, SQL, captura, materialização, DML, migration, rede, reconciliação,
backfill, deploy, mensagem, tool call, qualquer efeito vivo, `status`, `apply`,
