...
receipt global, saver, probe vivo, acesso a DEV ou PROD, logs, SQL, DML, outra
rede, deploy adicional, mensagem, tool call ou qualquer outro efeito vivo.
Tambem nao autoriza `AgentConfig`.
