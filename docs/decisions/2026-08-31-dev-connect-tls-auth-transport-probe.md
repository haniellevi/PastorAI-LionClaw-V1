...
Production, probe vivo, nova execução, retry, senha, autenticação, sessão de
banco, acesso a DEV ou PROD, logs, SQL, captura, materialização, DML, migration,
reconciliação, backfill, deploy, flag ou runtime.
