...
| Relatório de célula por WhatsApp | `PARCIAL / STAGING TRANSACIONAL OFFLINE CANDIDATO` | Snapshot, workflow, proposta, serviço ORM, locks nos writers web, UoW e coordenador fail-closed existem localmente; o coordenador aceita somente texto puro e recusa mídia/caption; não há caller, integração do coordenador com o resolvedor de reunião, consentimento aprovado, `AgentConfig`, commit, send ou efeito vivo |
