...
| LangGraph | `IMPLEMENTADO STATELESS / PREPARAÇÃO D3 INTEGRADA / FUNDAÇÃO D3 REPLAY-ONLY CANDIDATA OFFLINE` | Grafo único e fallback determinístico, sem checkpoint durável; identidade confiável está atrás de flag desligada, enquanto plano, receipts e adaptador replay-only permanecem sem persistência ou consumer de runtime |
