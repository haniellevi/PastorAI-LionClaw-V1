...
| LangGraph | `IMPLEMENTADO STATELESS / PREPARAÇÃO D3 INTEGRADA / FUNDAÇÃO D3 REPLAY-ONLY E CELL-REPORT CANDIDATAS OFFLINE` | Grafo único e fallback determinístico, sem checkpoint durável; a UoW do relatório existe somente como candidata local, sem caller, consentimento, `AgentConfig`, commit, send ou consumer de runtime |
