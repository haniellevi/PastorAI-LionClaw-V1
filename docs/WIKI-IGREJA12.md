...
`278afb205a3b4735d4aeb66e2e585f71fd562ef7`. O `bootstrap-ledger` permanece
...
`REVIEW_AND_INTEGRATE_DEV_IDENTITY_PREFLIGHT_RUNNER_PR`. Ele exige revisão
independente e CI PG17 TLS verde antes da integração e não autoriza executar o
preflight. O gate futuro, somente depois do merge, é
...
fora. Universidade da Vida e Capacitação Destino permanecem fora.
